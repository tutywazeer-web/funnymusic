...
BOT_USERNAME = "teamzyro_bot"
MONGO_DB_URI = "mongodb+srv://harshmanjhi1801:webapp@cluster0.xxwc4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
MESSAGE_DUMP = 100 
FILLERS = {}

BOT_OWNER = list({int(x) for x in ("6475224169").split()})

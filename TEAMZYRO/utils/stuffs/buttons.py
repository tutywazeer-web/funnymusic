...
class BUTTONS(object):
    MBUTTON = [
        [InlineKeyboardButton("CʜᴀᴛGPT 🤖", callback_data="mplus HELP_ChatGPT"), 
         ...
         InlineKeyboardButton("sᴛɪᴄᴋᴇʀs 🖼️", callback_data="mplus HELP_Sticker")],
        
        [InlineKeyboardButton("Tᴀɢ-Aʟʟ 🏷️", callback_data="mplus HELP_TagAll"),
         InlineKeyboardButton("Iɴꜰᴏ ℹ️", callback_data="mplus HELP_Info"), 
         InlineKeyboardButton("Exᴛʀᴀ ➕", callback_data="mplus HELP_Extra")],
        
        [InlineKeyboardButton("Iᴍᴀɢᴇ 🖼️", callback_data="mplus HELP_Image"),
        ...
        [InlineKeyboardButton("ɪᴍᴘᴏsᴛᴇʀ 🕵️", callback_data="mplus HELP_Imposter"),
         InlineKeyboardButton("Tʀᴜᴛʜ-ᗪᴀʀᴇ 🎲", callback_data="mplus HELP_TD"), 
         InlineKeyboardButton("ʜᴀsᴛᴀɢ #️⃣", callback_data="mplus HELP_HT")], 
        
        [InlineKeyboardButton("ᴛᴛs 🗣️", callback_data="mplus HELP_TTS"),
